...
try:
    ...
    cur.executemany(""" INSERT INTO Accounts VALUES(:1,:2,:3,:4,:5,:6,:7)""",[(counter,'Sajal','27-nov-1998','10-oct-2010','Savings','3639','2000'),(counter+1,'Prakhar','20-May-1999','12-Dec-2011','Current','2428','2000'),(counter+2,'Prajawal','24-May-1999','07-Nov-2009','Current','1415','2000'),(counter+3,'Ishaan','13-Jan-1999','24-Jun-2007','Savings','1234','2000')])
    con.commit()
